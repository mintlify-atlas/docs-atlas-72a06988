...
- Stored in `~/.openclaw/credentials/<channel>-allowFrom.json`
...
```bash
# This reads ~/.openclaw/credentials/<channel>-allowFrom.json
...
1. Edit `~/.openclaw/credentials/<channel>-allowFrom.json`
